function About() {
  return (
    <>
      <p className="text-gray-400 text-lg mb-5">April 16, 2025 &lt;3</p>
    ...
    <p className="text-2xl/8 font-medium mt-6">I'm always enthusiastic about the constantly growing technologies and genuinely craving them during my leisure time with a little dip of anime and manga!</p>
